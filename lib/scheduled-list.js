(function(exports) {
  ...
  list.prototype = {
    ...
    _reorderEnd: function(evt) {
      ...
      this.scheduler.stopDirectProtection();
      ...
      Promise.all([
        ...
        .then(toggleIndexPromotion.bind(null, this.scheduler, li, false))
        .then(toggleDraggingClass.bind(null, this.scheduler, li, false));
    },
