  ...
  list.prototype = {
    ...
    _reorderStart: function(evt) {
      ...
      var listenToMove = (function() {
        this.scheduler.attachDirect(this.list, 'touchmove', ctx.moveHandler);
      }).bind(this);
    ...
    _reorderEnd: function(evt) {
      ...
      var li = ctx.item;
      this.scheduler.detachDirect(this.list, 'touchmove', ctx.moveHandler);
    ...
    _reorderFinish: function(li) {
      ...
      return Promise.all([this._commitToDocument(),
                          toggleIndexPromotion(scheduler, li, false)]);
    },
