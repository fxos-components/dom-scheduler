...
(function(exports) {
  ...
  scheduler.prototype = {
    ...
    _transition: function(block, elm, evt, timeout, feedback) {
      if (naive) {
    ...
    _transitionFactory: function(transition) {
      return this._transition(transition.block, transition.elm,
        transition.evt, transition.timeout, transition.feedback);
    },

    // It is possible to execute multiple chained transitions in order to
    // avoid nested functions
    //
    // Returns a promise fullfilled at the end of the transitions for chaining
