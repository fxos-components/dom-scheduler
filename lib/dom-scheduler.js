...
(function(exports) {
  ...
  scheduler.prototype = {
    ...
    // XXX this needs to be part of a broader API change for event listener
    // - getting they're own requestAnimationFrameId
    // - stopping the protection when we remove the event listener
    stopDirectProtection: function() {
      this._directProtection = false;
